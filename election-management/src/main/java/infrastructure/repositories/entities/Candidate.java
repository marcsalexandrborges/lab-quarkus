...
public class Candidate {
    ...
    public static class create extends Candidate {
        public create(Optional<String> photo, String givenName, String familyName, String email, Optional<String> phone, Optional<String> jobTitle) {
            super();
        }
    }
}
